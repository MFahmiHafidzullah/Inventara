            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Kelola permintaan dan persetujuan barang keluar
                    </p>
                </div>
                <button
                                ...
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center space-x-2 mb-1">
                                            <span
                                                className={`inline-flex items-center space-x-1 px-2 py-0.5 rounded-lg text-xs font-semibold border ${statusConfig.bg} ${statusConfig.text} ${statusConfig.border}`}
                                            >
                                                <StatusIcon size={12} />
                                                <span>
                                                    {statusConfig.label}
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm mt-1">
                                    {activeFilter !== "all"
                                        ...
                                        : "Mulai dengan membuat request barang keluar"}
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                filteredTransaksi.map((item) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-sm">
                                                <span
                                                    className={`inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border ${statusConfig.bg} ${statusConfig.text} ${statusConfig.border}`}
                                                >
                                                    <StatusIcon size={14} />
                                                    <span>
                                                        {statusConfig.label}
